...
import { Icon, Text, Image, Button, Row, Column } from "components/shared";
import {
    WrapperInputFile,
    ButtonSelectMedia,
    InputMedia,
...
const InputFile = ({ type = "image", value, name, label, getDataField }) => {
        ...
        <WrapperInputFile>
            ...
            {!file && (
                <ButtonSelectMedia onClick={handleClickButton}>
                    ...
                    <Text fw="700" fs="1.1em" fs-sm="1em">
                        {label}
                    </Text>
                </ButtonSelectMedia>
            )}
                    ...
                    <WrapperCameraViewer>
                        ...
                        {!file && (
                            <>
                                ...
                                <Button br="100px" onClick={capture}>
                                    Tomar foto
                                </Button>
                            </>
                        )}
                        {file && (
                            <>
                                ...
                                <Button br="100px" onClick={() => setActiveWebCam(false)}>
                                    Confirmar
                                </Button>
                            </>
                        )}
